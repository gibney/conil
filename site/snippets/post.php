...
<div class="grid grid-cols-1 sm:grid-cols-6 lg:grid-cols-12 gap-4">
    ...
    <h2 class="text-lg">History Articles</h2>
    <?= $slots->menu()?> 
    </div>
    
    <!-- large screens - content middle -->
    <div class="col-span-1 order-first sm:col-span-4 lg:col-span-6 p-2 bg-purple-300">
        <article>
    ...
    <!-- tags and ads -->
    <div class="col-span-1 sm:col-span-2 lg:col-span-3 p-2 bg-pink-300">
