        ...
        <?php slot() ?>
            <?php foreach ($page->children()->listed()->shuffle() as $apartment) : ?>
                <div class="bg-gray-100 border border-gray-200 rounded-lg shadow">
                    ...
                    <div class="p-5">
                        <a href="<?= $apartment->link() ?>" target="_blank">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-sky-900"> <?= $apartment->title() ?></h5>
                        </a>
                        
                        <hr class="h-px my-2 bg-gray-200 border-0">

                        <?php if ($apartment->rating()->isNotEmpty()) : ?>
                            <p class="mb-1 text-base font-normal text-orange-600">
                        ...
                        <a href="<?= $apartment->link() ?>" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-orange-600 rounded-lg" target="_blank">
                            Check Availability
